...
const { createPost, likeAndUnlikePost, deletePost, getPostOffriends, updateCaption, commentOnPost, deleteComment, createPostOnlyCaption } = require("../controllers/post");
